...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            availableItems.put("C3H6", new LiquidItem("Propene", "C3H6", 20.0, 4.2));
            ...
            availableItems.put("B95", new LiquidItem("Benzene Super E95", "C6H6", 20.0, 7.3));
            availableItems.put("BEN", new LiquidItem("Benzene Super", "C6H6", 20.0, 7.3));
            availableItems.put("H2O", new LiquidItem("Water", "H2O", 0.0, 8.3));
            availableItems.put("MLK", new LiquidItem("Milk", "H2O+", 0.0, 8.6));
